...
**Attempts to solve the UI issue:**

Only updating the LogicManager to change Procedures accordingly (without the UI part)
--> correctly updates all the procedures, but the UI does not reflect the changes.