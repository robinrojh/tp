...
public class CommandTestUtil {
    ...
    public static final String VALID_PLAN_AMY = "EXPRESS 200MBps";
    public static final String VALID_PLAN_BOB = "NORMAL 100MBps";
    ...
    public static final String INVALID_PLAN_DESC = " " + PREFIX_PLAN; // empty string not allowed for addresses
