...
public class EditProcCommandTest {
	...
	public void execute_editProcedureFromExistingClient_success() {
		...
		EditProcedureDescriptor editProcedureDescriptor = new EditProcedureDescriptorBuilder(newProcedure).build();
		EditProcCommand editProcCommand = new EditProcCommand(INDEX_FIRST_CLIENT, INDEX_FIRST_PROCEDURE, editProcedureDescriptor);
		...
		String expectedMessage = String.format(EditProcCommand.MESSAGE_EDIT_PROCEDURE_SUCCESS, newProcedure, editedClient.getName(), editedClient.getAddress());
