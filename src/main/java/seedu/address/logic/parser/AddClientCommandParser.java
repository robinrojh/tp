    ...
    public AddClientCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_PHONE, PREFIX_EMAIL, PREFIX_ADDRESS,
                        PREFIX_PLAN, PREFIX_TAG);

        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_ADDRESS, PREFIX_PLAN, PREFIX_PHONE, PREFIX_EMAIL)
        ...
        Plan plan = ParserUtil.parsePlan(argMultimap.getValue(PREFIX_PLAN).get());
